...
<?php
				...
				/**
				 * iterate through the latest 4 published posts
				 *
...
<?php
						if ( has_post_thumbnail( $recent['ID'] ) ) {
							...
							$defaultSlideImage = get_template_directory_uri()
													.'/images/slider/' . $defaultImageName;

							echo '<img src="' . esc_url($defaultSlideImage) . '" />';
